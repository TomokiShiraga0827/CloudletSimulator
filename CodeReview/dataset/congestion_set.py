...
def make_congestion_binary1(system_end_time, device_num, MEC_resource, search_distance):
    # SUMO全体の計算時間
    ...
    for i in range(num):
        ...
        devices[i].set_congestion_status(system_end_time)        # 各デバイスのcongestion_status = [0] * system_time
    ...
    f = open('/home/tomokishiraga/PycharmProjects/simulation/CloudletSimulator/script/normal/device_compare/congestion_checked_devices1.binaryfile', 'wb')
