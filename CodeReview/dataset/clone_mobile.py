...
device_flag = False
# バイナリデータを読み込み
d = open('/home/tomokishiraga/PycharmProjects/simulation/CloudletSimulator/dataset/device.ns_start_binaryfile2', 'rb')
devices = pickle.load(d)  #バイナリの復元
...
#221秒間ある
f = open('/home/tomokishiraga/PycharmProjects/simulation/CloudletSimulator/dataset/device.clone_binaryfile2', 'wb')
